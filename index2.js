var gbifchecklistBank = function( ocrTxt ) {
	...
	/*this.loadNameUsage = function( callback, type, name) {                //didnt added to editedpage
		var name = name || "";
		var type = type || "unti";
	...
	this.writeToCache = function(name,data) {                             //added to editedpage
...
//adding of gbif.name_usage.all( {id}, {language} ,{datasetKey} );
...
this. gbifName_usageGetVerbatim= function( limit,offset, callback ) {
